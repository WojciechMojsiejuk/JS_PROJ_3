                    ...
                    <v-toolbar-title>
                     ...
                     <v-container align="center">
                         <v-row align="center">
                             ...
                             <v-layout>
                             <v-text-field v-model="search" :clear-icon-cb="clearSearch" clearable placeholder="Search songs by their title..."
...
<!--                                            </span>-->
        ...
        <v-row class="playlistEmpty" justify="center" v-if="!playlist.length">
            <h2 class="headline  font-weight-light" style="color: aliceblue;"> Your playlist is empty, please add songs</h2>
        </v-row>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            Playlist(){
                //Filter
                let playlist = this.playlist.filter((item) => {
                    if(this.search=='')
                    {
                        return true
                    }
